...
class ASR:
    ...
    def __Calculate_Stage_0(self, input: Bus, S_in: Bit) -> Bus:
        ...
        sign_bit = self.__Input_A.get_Line_bit(0) 
        ...
        for i in range(16):
            ...
            if i == 0: 
                self.__1bit__stage[i].set_Input_B(sign_bit)
            else:
    ...
    def __Calculate_Stage_1(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i <= 1:
                self.__2bit__stage[i].set_Input_B(sign_bit) 
            else:
    ...
    def __Calculate_Stage_2(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i <= 3: self.__4bit__stage[i].set_Input_B(sign_bit)
            else: self.__4bit__stage[i].set_Input_B(input.get_Line_bit(i - 4))
    ...
    def __Calculate_Stage_3(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i <= 7: self.__8bit__stage[i].set_Input_B(sign_bit)
            else: self.__8bit__stage[i].set_Input_B(input.get_Line_bit(i - 8))
