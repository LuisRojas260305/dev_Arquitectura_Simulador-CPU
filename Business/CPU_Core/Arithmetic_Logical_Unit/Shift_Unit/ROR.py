...
class ROR:
    ...
    def __Calculate_Stage_0(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i < K: 
                # Relleno ROR (K=1): Mapea Input_A[15] a Output[0]
                self.__1bit__stage[i].set_Input_B(self.__Input_A.get_Line_bit(16 - K + i)) 
            else:
    ...
    def __Calculate_Stage_1(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i < K:
                # Relleno ROR (K=2): Mapea Input_A[14, 15] a Output[0, 1]
                self.__2bit__stage[i].set_Input_B(self.__Input_A.get_Line_bit(16 - K + i))
            else:
    ...
    def __Calculate_Stage_2(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i < K: 
                # Relleno ROR (K=4): Mapea Input_A[12...15] a Output[0...3]
                self.__4bit__stage[i].set_Input_B(self.__Input_A.get_Line_bit(16 - K + i))
            else: 
    ...
    def __Calculate_Stage_3(self, input: Bus, S_in: Bit) -> Bus:
        ...
        for i in range(16):
            ...
            if i < K: 
                # Relleno ROR (K=8): Mapea Input_A[8...15] a Output[0...7]
                self.__8bit__stage[i].set_Input_B(self.__Input_A.get_Line_bit(16 - K + i))
            else: 
